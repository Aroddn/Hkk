...
public class PackOpeningArea : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        GlowColorsByRarity.Add(RarityOptions.UNCOMMON, RareColor);
        GlowColorsByRarity.Add(RarityOptions.RARE, EpicColor);
        GlowColorsByRarity.Add(RarityOptions.ULTRARARE, LegendaryColor);
    ...
    {      
        ...
        for (int i = 0; i < rarities.Length; i++)
        {
            ...
            {
                rarities[i] = RarityOptions.ULTRARARE;
        ...
        {
            rarities[Random.Range(0, rarities.Length)] = RarityOptions.UNCOMMON;
        }
